...
export default function Services() {
  ...
  const services = [
    {
      ...serviceIcons[0],
      title: t('servicesSection.cards.buy.title', 'Buy a Home'),
      desc: t('servicesSection.cards.buy.desc', 'Find your perfect home from our extensive collection of premium properties.')
    },
    {
      ...serviceIcons[1],
      title: t('servicesSection.cards.sell.title', 'Sell Property'),
      desc: t('servicesSection.cards.sell.desc', 'Get the best value for your property with our expert marketing and sales team.')
    },
    {
      ...serviceIcons[2],
      title: t('servicesSection.cards.rent.title', 'Rent a Property'),
      desc: t('servicesSection.cards.rent.desc', 'Discover rental properties that suit your lifestyle and budget perfectly.')
    },
    {
      ...serviceIcons[3],
      title: t('servicesSection.cards.manage.title', 'Property Management'),
      desc: t('servicesSection.cards.manage.desc', 'Professional property management services to maximize your investment returns.')
    }
  ]
